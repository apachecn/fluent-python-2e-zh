...
在 例 13-7](ch13.xhtml#ex_tombola_abc) 中，我们定义了`Tombola` ABC:一个像宾果笼子一样工作的类的接口。来自示例 13-10 的`LottoBlower`类是一个具体的实现。现在我们将研究`LottoBlower`的通用版本，就像在[示例 15-15 中使用的一样。
